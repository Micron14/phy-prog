...
\author{Borchetta Simone, Genovesi Antonio, Granieri Ginevra}
\date{5 luglio 2026}
...
\begin{center}
\small\textbf{Modifiche dalla consegna precedente:} Prima consegna ufficiale del progetto completo.
\end{center}
\hrule
\vspace{0.5cm}
