...
\begin{itemize}
    ...
    \item \textbf{\texttt{boid.hpp}}: Definisce la classe \texttt{Boid}, che modella l'agente fondamentale della simulazione. Questa classe incapsula lo stato fisico dell'entità (posizione e velocità) e i metodi necessari per implementare il comportamento collettivo basato sul modello di Reynolds (separazione, allineamento e coesione).
...
A titolo di esempio, il contenuto del file per una configurazione personalizzata massiva con 900 boids e 2 predatori si presenta in questo modo:
\begin{tcolorbox}[
...
900     & \textcolor{gray}{\% Numero di boids} \\
